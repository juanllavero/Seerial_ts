...
initialState,
reducers: {
    changeFullscreenSection: (state, action: PayloadAction<FullscreenSection>) => {
        state.fullscreenSection = action.payload;
    },
    setHomeInfoElement: (state, action: PayloadAction<HomeInfoElement | undefined>) => {
        state.homeInfoElement = action.payload;
    },
    setCurrentlyWatchingShows: (state, action: PayloadAction<HomeInfoElement[]>) => {
...
export const { changeFullscreenSection, setHomeInfoElement, setCurrentlyWatchingShows,
    setDominantColor, setHomeImageLoaded, setShowImageLoaded, setSeasonImageLoaded
