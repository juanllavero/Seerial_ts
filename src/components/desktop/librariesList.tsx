    ...
    return (
        <div className="libraries-list scroll">
            {libraries.map((library) => (
                ...
                <div>
                    <a id={library.id + "btn"} className="svg-button-desktop-transparent select" onClick={() => {
                    ...
                    <ul id={library.id + "dropdown"} className={`dropdown-menu ${libraryMenuOpen && library == libraryForMenu ? (' dropdown-menu-open'): ('')}`}>
                        <li key={library.id + "edit"}
                        onClick={() => {
                        dispatch(toggleLibraryMenu());
                        }}>
                            <span>Editar</span>
                        </li>
                        <li key={library.id + "search"}
                        onClick={() => {
                        dispatch(toggleLibraryMenu());
                        }}>
                            <span>Buscar archivos en la biblioteca</span>
                        </li>
                        <li key={library.id + "update"}
                        onClick={() => {
                        dispatch(toggleLibraryMenu());
                        }}>
                            <span>Actualizar metadatos</span>
                        </li>
                        <li key={library.id + "remove"}
                        onClick={() => {
                        dispatch(toggleLibraryMenu());
                        }}>
                            <span>Eliminar</span>
