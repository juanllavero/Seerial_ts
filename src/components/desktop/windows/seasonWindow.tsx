    ...
    const handleSavingChanges = () => {
        if (season) {
            dispatch(updateSeason({
                ...
                logoSrc: selectedLogo ? "resources/img/logos/" + season.id + "/" + selectedLogo : season.logoSrc,
                coverSrc: selectedPoster ? "resources/img/posters/" + season.id + "/" + selectedPoster : season.coverSrc,
