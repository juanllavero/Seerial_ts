		...
		<section className="albums-container">
			<div className="music-info-container">
				<div className="album-image">
					<LazyLoadImage
						src={currentSeason ? currentSeason.coverSrc : ""}
						alt="Poster"
						onError={(e: any) => {
				...
				<div className="collection-info">
					<span id="music-title">{currentShow && currentShow.name}</span>
					<div className="music-info-horizontal">
						<span>
							{currentShow &&
								(() => {
									const minYear = Math.min(
										...currentShow.seasons.map((season: SeasonData) =>
					...
					{currentEpisode && currentShow && currentShow.overview ? (
