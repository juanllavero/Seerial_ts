...
const MusicViewCards: React.FC<MusicViewProps> = ({ selectedLibrary }) => {
	...
	const handleSeasonSelection = (season: SeasonData | null) => {
		if (season) generateGradient(selectedCollection, season);
									...
									<div className="song-image-container">
										...
										<div className="song-btn-overlay">
											<button
												onClick={() => {
													dispatch(
														setSongs(selectedAlbum.episodes)
													);
			...
			<>
				...
				<section className="music-view-info-container">
					<div className="info-container">
						<div
							className={`loading-element-hover ${
								selectedCollection.analyzingFiles
									? "loading-visible"
									: ""
							}`}
							style={{
						...
						<div className="poster-image round-image">
							<LazyLoadImage
								src={selectedCollection.coverSrc}
								alt="Poster"
								onError={(e: any) => {
							...
							<span className="date">
								{(() => {
									const minYear = Math.min(
										...selectedCollection.seasons.map(
											(season: SeasonData) =>
						...
						>
							<div
								...
								onMouseEnter={() => {
									...
									if (!seriesMenuOpen) dispatch(toggleSeasonMenu());
								}}
								onMouseLeave={() => {
									dispatch(showMenu(false));
								}}
							...
							>
								<div className="video-button-image-section">
									...
									>
										<div
											className="series-selection-div"
											onClick={() => handleSeasonSelection(album)}
										></div>
										<div className="bottom-btns">
											<button
												className="svg-button-desktop-transparent"
					...
					<section className="album-info-container">
						<div className="info-container">
							...
							<section className="season-info">
								<a
									id="seriesTitle"
									onClick={() => dispatch(selectSeason(null))}
								>
